 ...
 * sem ele, qualquer sessão válida do Portal renderiza a área do cliente.
 *
 ...
 * primeiras falharem.
 */
export default async function LayoutContratante({ children }: { children: ReactNode }) {
  const usuario = await exigirTipo("contratante");
